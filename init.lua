...
stamina.settings = {
	...
	exhaust_dig = get_setting("exhaust_dig", 1),
	exhaust_place = get_setting("exhaust_place", 0.2),
	exhaust_move = get_setting("exhaust_move", 0.4),
	exhaust_jump = get_setting("exhaust_jump", 1),
	exhaust_craft = get_setting("exhaust_craft", 5),
	exhaust_punch = get_setting("exhaust_punch", 8),
