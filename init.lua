...
stamina.settings = {
	...
	sprint_particles = minetest.settings:get_bool("stamina.sprint_particles", false),
	...
	exhaust_dig = get_setting("exhaust_dig", 1.5),
	...
	exhaust_punch = get_setting("exhaust_punch", 10),
